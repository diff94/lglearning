...
// 1 == 1
// He began a book. (semantic coercion:a book (N) -> write a book (V))
//類型強制轉換
...
const plus1 = (x) => x + 1; // The input x maps to the output x + 1 定義function
                            //可以用箭頭來表達
...
points.dist = function () {
  ...
  let p1 = this[0]; // First element of array we're invoked on 放到p1
...
//變數名稱 camel notation: myBook 第二字首字母要大寫
